...
public class Configuration {
  ...
  public static final String DATABASE_USERNAME = System.getenv().getOrDefault("DATABASE_USERNAME", "postgres");
  public static final String DATABASE_PASSWORD = System.getenv().getOrDefault("DATABASE_PASSWORD", "lorenzo");
  public static final String DATABASE_URL = "jdbc:postgresql://" + DATABASE_HOST + "/GDHub?user=" + DATABASE_USERNAME + "&password=" + DATABASE_PASSWORD + "&useSSL=false&serverTimezone=" + SERVER_TIMEZONE;
  */
