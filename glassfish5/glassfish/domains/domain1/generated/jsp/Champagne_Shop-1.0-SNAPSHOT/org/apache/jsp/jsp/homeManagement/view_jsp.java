...
if (loggedOn) {
      ...
      out.write("      Benvenuto ");
if(loggedUser.isAdmin()){
      out.write(" amministratore");
}
      out.write(' ');
      out.print(loggedUser.getNome());
      out.write(' ');
      out.print(loggedUser.getCognome());
      out.write("!<br/>\r\n");
      out.write("      ");
} else {
      out.write("\r\n");
      out.write("      Benvenuto.\r\n");
      out.write("      Fai il logon per gestire la tua pagina.\r\n");
      out.write("      ");
}
      out.write("\r\n");
      out.write("      <table>\r\n");
      out.write("        <caption>Elementi in promozione</caption>\r\n");
      out.write("        ");
for(int i = 0; i < prodottiVetrina.size(); i++) {
      out.write("\r\n");
      out.write("          <tr>\r\n");
      out.write("            <td><img src=\"images/");
      out.print(prodottiVetrina.get(i).getUrlImage());
      out.write("\" alt=\"Immagine prodotto\"></td>\r\n");
      out.write("            <td style=\"width: 80%\">");
      out.print(prodottiVetrina.get(i).getDescrizione());
      out.write("</td>\r\n");
      out.write("            <td>");
      out.print(prodottiVetrina.get(i).getPrezzoUnitario());
      out.write(" euro</td>\r\n");
      out.write("          </tr>\r\n");
      out.write("        ");
}
